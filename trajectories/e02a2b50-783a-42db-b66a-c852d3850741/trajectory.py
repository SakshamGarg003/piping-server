...
# 1. Initialize Workspace - hammer Escape to dismiss stacked popups + close
#    any auto-opened welcome editor. press(..., presses=5, interval=0.3)
#    fires Escape five times so layered popups (Python recommendation, etc.)
#    are all dismissed in one call.
press("escape", presses=5, interval=0.3)
sleep(1)
hotkey("ctrl", "k")
sleep(1)
press("w")
